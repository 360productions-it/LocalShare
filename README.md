...
[![GitHub Release](https://img.shields.io/github/v/release/360productions-it/LocalShare?color=blue&logo=github)](https://github.com/360productions-it/LocalShare/releases)
...
1. Download the latest `LocalShare_Setup_vX.X.X.exe` from [GitHub Releases](https://github.com/360productions-it/LocalShare/releases).
2. Run the installer.
...
2. Clone the repository:
   ```powershell
   git clone https://github.com/360productions-it/LocalShare.git
   cd LocalShare
   ```
...
powershell -File .\build-release.ps1 -Version 2.0.6 -GitHubToken "ghp_yourPersonalAccessTokenHere"
```

### Build Installer Locally (Without Publishing)
```powershell
# Compiles the standalone executable and generates dist\installer\LocalShare_Setup_v2.0.6.exe
powershell -File .\build-release.ps1 -Version 2.0.6
```
